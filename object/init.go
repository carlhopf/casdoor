...
func initBuiltInApplication() {
	...
	application = &Application{
		...
		SignupItems: []*SignupItem{
			...
			{Name: "Username", Visible: false, Required: false, Prompted: false, Rule: "None"},
			{Name: "Display name", Visible: false, Required: false, Prompted: false, Rule: "None"},
			{Name: "Password", Visible: true, Required: true, Prompted: false, Rule: "None"},
			{Name: "Confirm password", Visible: true, Required: true, Prompted: false, Rule: "None"},
			{Name: "Phone", Visible: false, Required: false, Prompted: false, Rule: "None"},
